...
public class Activity8 {
    public static void main(String[] args) {
        ...
        //builder.click(cargoLock).pause(1000).moveToElement(cargoToml).pause(500).click(cargoToml).pause(1000).build().perform();
        builder.click(cargoLock).pause(1000).click(cargoToml).pause(1000).build().perform();
        ...
        builder.doubleClick(srcButton).pause(1000).pause(1000)
        .contextClick(targetButton).pause(1000).build().perform();
